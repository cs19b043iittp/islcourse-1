...
def get_data_circles(n_points=100):
    X, y = datasets.make_circles(n_samples=n_points, noise=0.1, factor=.4, random_state = 42)
...
def build_kmeans(X=None, k=10):
    km = cluster.KMeans(n_clusters=2, n_init=k, random_state=42)
    km.fit(X)
